...
|修订版本号|迭代日期|修订内容|迭代者|
|---------|-------|--------|-----|
|v1.0|11.20-12.11|文档初稿撰写，建立基本产品文档框架|胡凯锋|
|v2.0|12.11-12.13|测试可用 |胡凯锋|
|v3.0|12.13-12.15|选定 API 类型并实现测试运行，产品后台代码实现可用|胡凯锋|
|v4.0|12.18-12.27|开发 APP 原型，制作低保真原型初步实现逻辑|胡凯锋|
...
### （二）信息设计
1）产品框架图
![框架图](https://images.gitee.com/uploads/images/2019/1229/175831_4ee64af7_2350059.png)

2）产品流程图
![流程图](https://images.gitee.com/uploads/images/2019/1229/175831_cb9589bc_2350059.png)
